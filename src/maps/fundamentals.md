...
**Figure 1**: Geographic coordinates overview with <span style="color:blue">parallels</span> (blue) and <span style="color:red">parallels</span> (red). The prime meridian (longitude 0°) intersects Greenwich.
